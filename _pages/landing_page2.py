...
def show_landing_page():
    ...
    * {
    ...
    st.markdown('<div class="modern-divider"></div>', unsafe_allow_html=True)
    # ==================== Feature: Tender Intelligence Suite ====================
    st.markdown("""
        <div style="text-align: center;">
            <h2 class="section-title" style="text-align: center;">🔍 Tender Intelligence Suite</h2>
            <p class="section-subtitle" style="text-align: center;">e-GP টেন্ডার আমদানি, উইনার প্রেডিকশন এবং NPPI রিভার্স ইঞ্জিনিয়ারিং — একসাথে</p>
        </div>
    """, unsafe_allow_html=True)

    # Use Streamlit columns with equal height
    col1, col2, col3 = st.columns(3)

    with col1:
        st.markdown("""
            <div style="background: white; border-radius: 16px; padding: 28px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); border: 1px solid #e2e8f0; height: 100%; display: flex; flex-direction: column;">
                <div style="font-size: 2.8rem; margin-bottom: 16px;">📥</div>
                <div style="font-size: 1.35rem; font-weight: 700; margin-bottom: 8px; color: #1e3a8a;">Smart Tender Import</div>
                <div style="color: #475569; margin-bottom: 20px;">e-GP ওপেনিং রিপোর্ট এক ক্লিকে আমদানি করুন</div>
                <ul style="color: #64748b; padding-left: 20px; margin-bottom: 30px; flex-grow: 1;">
                    <li>⚡ Auto-detect competitors & bid amounts</li>
                    <li>🔗 Automatic linking with existing tenders</li>
                    <li>📊 Instant NPPI & SLT calculation</li>
                    <li>👥 Competitor master profile update</li>
                    <li>✅ Excel-style editable bid table</li>
                </ul>
           </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
            <div style="background: white; border-radius: 16px; padding: 28px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); border: 1px solid #e2e8f0; height: 100%; display: flex; flex-direction: column;">
                <div style="font-size: 2.8rem; margin-bottom: 16px;">🔮</div>
                <div style="font-size: 1.35rem; font-weight: 700; margin-bottom: 8px; color: #1e3a8a;">Winner Prediction + NPPI Intelligence</div>
                <div style="color: #475569; margin-bottom: 20px;">ফলাফল ঘোষণার আগে জানুন কে জিততে পারে এবং কোন NPPI কাজ করবে</div>
                <ul style="color: #64748b; padding-left: 20px; margin-bottom: 30px; flex-grow: 1;">
                    <li>🎯 Pre-award Winner Prediction (NPPI Range + SLT)</li>
                    <li>🔍 NPPI Reverse Engineering for awarded tenders</li>
                    <li>📈 Dynamic NPPI Sensitivity Analysis</li>
                    <li>📊 Visual distribution & margin analysis</li>
    ...
    with col3:
        st.markdown("""
            <div style="background: white; border-radius: 16px; padding: 28px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); border: 1px solid #e2e8f0; height: 100%; display: flex; flex-direction: column;">
                <div style="font-size: 2.8rem; margin-bottom: 16px;">📄</div>
                <div style="font-size: 1.35rem; font-weight: 700; margin-bottom: 8px; color: #1e3a8a;">Professional Reports</div>
                <div style="color: #475569; margin-bottom: 20px;">সুন্দর ব্র্যান্ডেড রিপোর্ট এক ক্লিকে জেনারেট করুন</div>
                <ul style="color: #64748b; padding-left: 20px; margin-bottom: 30px; flex-grow: 1;">
                    <li>🏆 Beautiful HTML reports with TenderAI branding</li>
                    <li>📊 SLT Analysis + NPPI Insights</li>
                    <li>📈 Sensitivity Charts & Bid Comparison</li>
                    <li>🔄 Works for both awarded & non-awarded tenders</li>
                    <li>📤 Export as HTML, PDF-ready</li>
                </ul>                
            </div>
        """, unsafe_allow_html=True)
    ...
    # Impact Section
    st.markdown("""
        <div style="background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); border-radius: 20px; padding: 2rem; margin: 2.5rem 0; color: white; text-align: center;">
            <h3 style="color: white; font-size: 1.8rem; margin-bottom: 1rem;">📊 Real Impact of Tender Intelligence Suite</h3>
            <div style="display: flex; justify-content: space-around; flex-wrap: wrap; gap: 2rem; margin-top: 1.5rem;">
                <div>
                    <div style="font-size: 2.5rem; font-weight: 800;">68%</div>
                    <div style="font-size: 0.95rem; opacity: 0.9;">Better Bid Strategy</div>
                </div>
                <div>
                    <div style="font-size: 2.5rem; font-weight: 800;">2.4x</div>
                    <div style="font-size: 0.95rem; opacity: 0.9;">Faster Analysis</div>
                </div>
                <div>
                    <div style="font-size: 2.5rem; font-weight: 800;">91%</div>
                    <div style="font-size: 0.95rem; opacity: 0.9;">NPPI Discovery Accuracy</div>
                </div>
            </div>
            <p style="margin-top: 1.8rem; font-size: 0.95rem; opacity: 0.9;">
                *Based on testing with real e-GP data from Bangladeshi contractors
            </p>
        </div>
    """, unsafe_allow_html=True)
    ...
    faqs = [
        ...
        {    "question_en": "What is NPPI Reverse Engineering?",
            "question_bn": "NPPI Reverse Engineering কী?",
            "answer_en": "It analyzes hundreds of possible NPPI values to discover which specific factor made the declared winner have the lowest evaluated price according to e-GP logic.",
            "answer_bn": "এটি শত শত সম্ভাব্য NPPI মান বিশ্লেষণ করে আবিষ্কার করে যে কোন নির্দিষ্ট ফ্যাক্টর ব্যবহার করে e-GP ঘোষিত বিজয়ীকে সর্বনিম্ন মূল্যায়িত দর হিসেবে নির্বাচন করেছে।"
        },
        {
            "question_en": "What is NPPI Sensitivity Analysis?",
            "question_bn": "NPPI Sensitivity Analysis কী?",
            "answer_en": "It shows how different NPPI values (0.80 to 0.99) affect the lowest evaluated price and who would win under each scenario. This helps you understand the competitive landscape and price your bids more strategically.",
            "answer_bn": "এটি দেখায় বিভিন্ন NPPI মান (০.৮০ থেকে ০.৯৯) সর্বনিম্ন মূল্যায়িত দরকে কীভাবে প্রভাবিত করে এবং প্রতিটি পরিস্থিতিতে কে জিততে পারে। এটি আপনাকে প্রতিযোগিতার চিত্র বুঝতে এবং বিড মূল্য কৌশলগতভাবে নির্ধারণ করতে সাহায্য করে।"
        },
        {
            "question_en": "Can I predict the winner before the result is declared?",
            "question_bn": "ফলাফল ঘোষণার আগে বিজয়ী পূর্বাভাস করা যায়?",
            "answer_en": "Yes! The Winner Prediction tool works on any tender with bid data. It simulates multiple NPPI ranges and SLT thresholds to show the most likely winner.",
            "answer_bn": "হ্যাঁ! Winner Prediction টুল যেকোনো টেন্ডারে কাজ করে যেখানে বিড ডেটা আছে। এটি একাধিক NPPI রেঞ্জ এবং SLT থ্রেশহোল্ড সিমুলেট করে সবচেয়ে সম্ভাব্য বিজয়ী দেখায়।"
        },
        {
            "question_en": "How accurate is the NPPI discovery?",
            "question_bn": "NPPI আবিষ্কার কতটা নির্ভুল?",
            "answer_en": "Very accurate for most cases. The system finds the narrow range of NPPI values that consistently make the declared winner #1 in evaluated price.",
            "answer_bn": "অধিকাংশ ক্ষেত্রে খুবই নির্ভুল। সিস্টেম সেই সংকীর্ণ NPPI রেঞ্জ খুঁজে বের করে যা ঘোষিত বিজয়ীকে মূল্যায়িত দরে সবসময় #১ করে।"
        }
    ]
