...
def render_top_navigation():
    ...
    is_individual_user = user_role == 'individual'
    ...
    if is_system_admin:
        nav_items = [
            ...
            ("🔮 Simulator", "competitive_intel"), ("🏢 AutoFill", "company_knowledge"),
        ...
        nav_items = [
            ...
            ("🏢 AutoFill", "company_knowledge"), ("🤖 Ext", "extension_usage"),
            ("🤖 CompetitorMan", "competitor_master"),
    ...
    elif is_company_admin or is_individual_user:
        nav_items = [
            ("🏠 Dash", "dashboard"), ("📊 Analytics", "company_analytics"),
            ("📋 Tenders", "tender_management"), ("📊 Rates", "rate_viewer"),
            ("📊 BOQ", "boq_generator"), ("📈 Basic", "quick_bid"),
            ("🎯 Adv Opt", "advanced_bid"), ("🔮 Simulator", "competitive_intel"), ("🎯 AI Advisor", "ai_advisor"), 
            ("🏢 AutoFill", "company_knowledge"), ("📥 Ext", "extension_download"),
        ...
        if is_premium:
            ...
            ("🎯 Adv Opt", "advanced_bid"), 
                ...
                ("🏢 AutoFill", "company_knowledge"), ("🤖 Extension", "extension_usage")
            ]
        nav_items += [
        ...
        nav_items = [
            ...
            ("📥 Ext", "extension_download"), ("🏢 AutoFill", "company_knowledge"),
