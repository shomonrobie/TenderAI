...
ROLE_PERMISSIONS: Dict[str, Dict[str, bool]] = {
    ...
    'company_admin': {
        ...
        'can_import_pricing': True,
        'can_export_pricing': True,
        'can_reset_pricing': True,
        'can_apply_bulk_changes': True,
    ...
    'analyst': {
        ...
        'can_import_pricing': False,
        'can_export_pricing': True,
        'can_reset_pricing': False,
        'can_apply_bulk_changes': False,
...
def can_import_tender_data() -> bool:
    return _rbac.has_permission('can_import_tender_data')
...
def can_edit_pricing() -> bool:
    return _rbac.has_permission('can_edit_pricing')

def can_import_pricing() -> bool:
    return _rbac.has_permission('can_import_pricing')

def can_export_pricing() -> bool:
    return _rbac.has_permission('can_export_pricing')

def can_reset_pricing() -> bool:
    return _rbac.has_permission('can_reset_pricing')

def can_apply_bulk_changes() -> bool:
    return _rbac.has_permission('can_apply_bulk_changes')
